...
lines(sweights[,"year"], sweights$s.6, col="purple", bty="l",type="l")
points(cweights$X, cweights$X6, col="purple", pch=20, lwd=1.6)

lines(sweights[,"year"], sweights$s.7, col="orange", bty="l",type="l")
points(cweights$X, cweights$X7, col="orange", pch=20, lwd=1.6)

lines(sweights[,"year"], sweights$s.8, col="grey", bty="l",type="l")
points(cweights$X, cweights$X8, col="grey", pch=20, lwd=1.6)

legend("topleft", legend=c("0","1","2","3","4","5","6","7","8+"),  col=c("magenta","red","blue","green","cyan","black","purple","orange", "grey"),lwd=1.6, bty="n",ncol=2 )
...
points(Mat0[Mat0$age==6,"year"], Mat0[Mat0$age==6,"weight"] ,col="purple", pch=20, lwd=1.6)
lines(matog$year, matog$s.6, col="purple")
points(Mat0[Mat0$age==7,"year"], Mat0[Mat0$age==7,"weight"], col="orange", pch=1, lwd=1.6)
lines(matog$year, matog$s.7, col="orange")
points(Mat0[Mat0$age==8,"year"], Mat0[Mat0$age==8,"weight"], col="grey", pch=17, lwd=1.6)
lines(matog$year, matog$s.8, col="grey")

legend("topleft", legend=c("1","2","3","4","5","6","7","8+"),  col=c("red","green","blue","cyan","black","purple","orange", "grey"),lwd=1.6, bty="n",ncol=2 )
...
lines(matog$year, matog$s.5, col="black")
points(Mat0[Mat0$age==6,"year"], Mat0[Mat0$age==6,"lengths"] ,col="purple", pch=20, lwd=1.6)
lines(matog$year, matog$s.6, col="purple")
points(Mat0[Mat0$age==7,"year"], Mat0[Mat0$age==7,"lengths"], col="orange", pch=1, lwd=1.6)
lines(matog$year, matog$s.7, col="orange")
points(Mat0[Mat0$age==8,"year"], Mat0[Mat0$age==8,"lengths"], col="grey", pch=17, lwd=1.6)
lines(matog$year, matog$s.8, col="grey")

legend("bottomright", legend=c("1","2","3","4","5","6","7","8+"),  col=c("red","green","blue","cyan","black","purple","orange", "grey"),lwd=1.6, bty="n",ncol=2 )
...
for (i in 1:cutage){
  if(i%in%c(1:6))  plot(Mat0[Mat0$age==i & Mat0$year==2000,"length"], Mat0[Mat0$age==i& Mat0$year==2000,"nb"]/sum(Mat0[Mat0$age==i& Mat0$year==2000,"nb"]), col="orange", xlim=c(0,65),ylim=c(0,0.3),main=paste("age",i), pch=20,type="l", xlab="", ylab="Proportion", bty="l")
  
  if(i%in%c(7:8))  plot(Mat0[Mat0$age==i & Mat0$year==2000,"length"], Mat0[Mat0$age==i& Mat0$year==2000,"nb"]/sum(Mat0[Mat0$age==i& Mat0$year==2000,"nb"]), col="orange", xlim=c(0,65),ylim=c(0,0.3),main=paste("age",i), pch=20,type="l", xlab="Length (cm)", ylab="Proportion", bty="l")
  lines(Mat0[Mat0$age==i & Mat0$year==2005,"length"], Mat0[Mat0$age==i& Mat0$year==2005,"nb"]/sum(Mat0[Mat0$age==i& Mat0$year==2005,"nb"]), col="red", lwd=1.6,type="l")
  lines(Mat0[Mat0$age==i & Mat0$year==2010,"length"], Mat0[Mat0$age==i& Mat0$year==2010,"nb"]/sum(Mat0[Mat0$age==i& Mat0$year==2010,"nb"]), col="purple", lwd=1.6,type="l")
  lines(Mat0[Mat0$age==i & Mat0$year==2015,"length"], Mat0[Mat0$age==i& Mat0$year==2015,"nb"]/sum(Mat0[Mat0$age==i& Mat0$year==2015,"nb"]), col="blue", lwd=1.6,type="l")
  
  lines(Mat0[Mat0$age==i & Mat0$year==year,"length"], Mat0[Mat0$age==i& Mat0$year==year,"nb"]/sum(Mat0[Mat0$age==i& Mat0$year==year,"nb"]), col="black", lwd=1.6,type="l")
  if(i==2) legend("topright", legend=c("2000","2005","2010","2015","2019"),  col=c("orange","red","purple","blue", "black"),lwd=1.6, bty="n",ncol=2, cex=1 )
...
legend("topright", legend=c("0","1","2","3","4","5","6","7","8+"),  col=c("magenta","red","green","blue","cyan","black","purple","orange", "grey"),lwd=1.6, bty="n",ncol=2 )
...
axis(2,at=c(1:9)*100)
lines(Mat0_old[Mat0_old$age==0,"year"], Mat0_old[Mat0_old$age==0,"weight"]*1000, col="magenta", lwd=1.6,lty="dashed")
lines(Mat0_old[Mat0_old$age==1,"year"], Mat0_old[Mat0_old$age==1,"weight"]*1000, col="red", lwd=1.6,lty="dashed")
lines(Mat0_old[Mat0_old$age==2,"year"], Mat0_old[Mat0_old$age==2,"weight"]*1000, col="green", lwd=1.6,lty="dashed")
lines(Mat0_old[Mat0_old$age==3,"year"], Mat0_old[Mat0_old$age==3,"weight"]*1000, col="blue", lwd=1.6,lty="dashed")
lines(Mat0_old[Mat0_old$age==4,"year"], Mat0_old[Mat0_old$age==4,"weight"]*1000, col="cyan",  lwd=1.6,lty="dashed")
lines(Mat0_old[Mat0_old$age==5,"year"], Mat0_old[Mat0_old$age==5,"weight"]*1000, col="black",  lwd=1.6,lty="dashed")
lines(Mat0_old[Mat0_old$age==6,"year"], Mat0_old[Mat0_old$age==6,"weight"]*1000 ,col="purple",  lwd=1.6,lty="dashed")
lines(Mat0_old[Mat0_old$age==7,"year"], Mat0_old[Mat0_old$age==7,"weight"]*1000, col="orange", lwd=1.6,lty="dashed")
lines(Mat0_old[Mat0_old$age==8,"year"], Mat0_old[Mat0_old$age==8,"weight"]*1000, col="grey",  lwd=1.6,lty="dashed")
...
lines(Mat0[Mat0$age==7,"year"], Mat0[Mat0$age==7,"weight"], col="orange", lwd=1.6)
lines(Mat0[Mat0$age==8,"year"], Mat0[Mat0$age==8,"weight"], col="grey",  lwd=1.6)
